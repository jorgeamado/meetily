...
export function SummaryPanel({
  ...
  return (
    <div className="relative flex-1 min-w-0 flex flex-col bg-white overflow-hidden">
      {/* Title area */}
      ...
      {isSummaryLoading ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {summaryResponse && (
            <div className="absolute inset-x-0 bottom-0 bg-white shadow-lg p-4 max-h-1/3 overflow-y-auto">
